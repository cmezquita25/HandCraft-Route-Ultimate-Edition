...
namespace Handcraft_Route.api.Controllers
{
    ...
    public class ArteCoopController : ControllerBase
    {
        ...
        //DTO ARTESANOS COOPERATIVA REQUEST
        #region"Request"
        private ArtesanosCooperativa CreateObjectFromDto(ArtesanosCooperativaResquest dto)
        {
            var query = new ArtesanosCooperativa {
                IdCooperativa = 0,
                NombreComercio = string.Empty,
                Descripcion = string.Empty,
                Platillo1 = string.Empty,
                Platillo2 = string.Empty,
                Platillo3 = string.Empty,
