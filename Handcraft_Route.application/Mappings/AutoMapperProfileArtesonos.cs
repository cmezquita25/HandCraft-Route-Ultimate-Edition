...
namespace Handcraft_Route.application.Mappings
{
    public class AutoMapperProfileArtesonos : Profile
    {
        public AutoMapperProfileArtesonos()
        {
            ...
            .ForMember(dest => dest.MasInfo, opt => opt.MapFrom(src => $"Para mas informacion del artesano consultar: - Correo electronico: {src.Correo} -Redes sociales: {src.RedesSociales}"));
